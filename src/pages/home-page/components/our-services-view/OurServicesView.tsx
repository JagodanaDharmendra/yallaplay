function OurServicesView() {
  return (
    <div className="flex flex-col py-4 items-center text-center w-full justify-center">
      <div className="flex w-full flex-col justify-center content-center items-center">
        ...
        <p className="text-white my-5 px-4 lg:px-12 opacity-70 text-justify max-w-2xl">
          ...
          from monetization to user acquisition. Have a chat with us and tell
          you more about your project.
        </p>
      </div>
    </div>
  );
